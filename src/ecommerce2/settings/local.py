...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, "today/templates/today"),
           #os.path.join(BASE_DIR, "carts/templates/"), still it works, even after commenting, 
                #....just make sure everytime you do "carts/template_name.html" (i.e appname must be present)
         ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
